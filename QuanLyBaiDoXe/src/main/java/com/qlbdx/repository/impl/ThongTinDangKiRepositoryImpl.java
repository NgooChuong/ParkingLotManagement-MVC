    ...
    public List<Object[]> getThongTinChoDaDangKy(int choDoId, Map<String, String> params) {
        ...
        if (params != null) {
            ...
            if (bienso != null && !bienso.isEmpty()) {
                ...
                predicates.add(cb.like(xeJoin.get("bienSo"), "%" + bienso + "%"));
            }
            ...
            System.out.println(thoigianvobai);
            System.out.println(thoigianrabai);
//            SimpleDateFormat dateFormat = new SimpleDateFormat("yyyy-MM-dd'T'HH:mm:ss");
            ...
            if (thoigianvobai != null && !thoigianvobai.isEmpty() && thoigianrabai != null && !thoigianrabai.isEmpty()) {
                ...
                try {
                    Timestamp vobaiDate = new Timestamp(new SimpleDateFormat("yyyy-MM-dd'T'HH:mm").parse(thoigianvobai).getTime());
                    Timestamp rabaiDate = new Timestamp(new SimpleDateFormat("yyyy-MM-dd'T'HH:mm").parse(thoigianrabai).getTime());

//                    Date vobaiDate = dateFormat.parse(thoigianvobai);
//                    Date rabaiDate = dateFormat.parse(thoigianrabai);
                    System.out.println(vobaiDate);
                    System.out.println(rabaiDate);

                    // Thêm điều kiện BETWEEN cho trường thoiGianRaBai và thoiGianVoBai
                    predicates.add(cb.greaterThanOrEqualTo(ttdkRoot.get("thoiGianRaBai"), vobaiDate));
                    predicates.add(cb.lessThanOrEqualTo(ttdkRoot.get("thoiGianVoBai"), rabaiDate));
